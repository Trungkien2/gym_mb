...
import 'package:riverpod_tour/common/common_widget/step_detail_row.dart';
            ...
            children: [
              Stack(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () {
                      print(widget.eObj["link"].toString());

                      _dialogBuilder(context, widget.eObj["link"].toString());
                    },
                    icon: Image.asset(
                      "asset/img/Play.png",
                      width: 30,
...
Future<void> _dialogBuilder(BuildContext context, link) {
  return showDialog<void>(
    context: context,
    builder: (BuildContext context) {
      return AlertDialog(
        content: YoutubeWidget(link: link),
        actions: <Widget>[
          TextButton(
