...
import 'package:riverpod_tour/common/common_widget/food_step_detail_row.dart';
...
class FoodInfoDetailsView extends ConsumerStatefulWidget {
  ...
  ConsumerState<FoodInfoDetailsView> createState() =>
      _FoodInfoDetailsViewState();
}

class _FoodInfoDetailsViewState extends ConsumerState<FoodInfoDetailsView> {
  List nutritionArr = [
    {"image": "asset/img/burn.png", "title": "180kCal"},
    {"image": "asset/img/egg.png", "title": "30g fats"},
    {"image": "asset/img/proteins.png", "title": "20g proteins"},
    {"image": "asset/img/carbo.png", "title": "50g carbo"},
  ];

  List ingredientsArr = [
    {"image": "asset/img/flour.png", "title": "Wheat Flour", "value": "100grm"},
    {"image": "asset/img/sugar.png", "title": "Sugar", "value": "3 tbsp"},
    {
      "image": "asset/img/baking_soda.png",
      "title": "Baking Soda",
      "value": "2tsp"
    },
    {"image": "asset/img/eggs.png", "title": "Eggs", "value": "2 items"},
  ];
